...
var courseInfo = {
    ...
    finalExamDates: [
        new FinalExamDay("101", new Date("12/5/2020 10:15:00")),
        new FinalExamDay("102", new Date("12/3/2020 12:45:00"))
    ],
...
//             assign: new Assignment("RandomArt", "assign/assign04.html", 1000000000)
        ...
        },
        {
            ...
            assign: new Assignment("BST", "assign/assign05.html", 13)
        },
        {
...
//         },
        ...
        },
        {
            ...
            assign: new Assignment("AATree", "assign/assign06.html", 11)
        },
        {
